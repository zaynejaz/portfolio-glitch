...
var pageEl = document.querySelector("#pageContainer");
...
(function () {
	...
	document.querySelector("#header-logo").addEventListener("mouseover", animateZELogo);
